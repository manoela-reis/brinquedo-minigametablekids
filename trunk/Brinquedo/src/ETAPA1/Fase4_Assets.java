...
public class Fase4_Assets extends Scene {
	...
	public Fase4_Assets(Context context) {
		...
		geometricFigures[2] = img.ImageManager("elefante-02.png");
		geometricFigures[3] = img.ImageManager("javaliCor-05.png");
		geometricFigures[4] = img.ImageManager("cervoCor-06.png");
	...
	public void setconf(int larg, int Alt) {
		...
		WidthBitmap[1] = geometricFigures[4].getWidth()
				* ((int) (20 * this.alt / 30) - (10 * this.alt / 30))
		...
		rectColor[1].set((int) (10.9f * this.larg / 20), 7 * this.alt / 8 - 7
				* HeightBitmap[1] / 10, (int) ((10.9 + 7 * 3.2 / 10)
				* this.larg / 20), 7 * this.alt / 8);
