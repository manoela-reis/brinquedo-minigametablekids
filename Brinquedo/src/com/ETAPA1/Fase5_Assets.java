...
public class Fase5_Assets extends Scene {
	...
	public void setconf(int larg, int Alt) {
		...
		rect[0].set((int) (3.5 * this.larg / 40 - WidthBitmap[0] / 2),
				...
				(int) (9 * this.alt / 40));
		WidthBitmap[1] = geometricFigures[5].getWidth()
				* ((int) (19 * this.alt / 40) - (int) (9.5 * this.alt / 40))
		...
		rect[2].set((int) (3.5 * this.larg / 40 - WidthBitmap[2] / 2),
				...
				(int) (28 * this.alt / 40));
		WidthBitmap[3] = geometricFigures[7].getWidth()
				* ((int) (38 * this.alt / 40) - (int) (28.5 * this.alt / 40))
				/ geometricFigures[7].getHeight();

		rect[3].set((int) (3.5 * this.larg / 40 - WidthBitmap[3] / 2),
				(int) (28.5 * this.alt / 40),
				(int) (3.5 * this.larg / 40 + WidthBitmap[3] / 2),
				(int) (38 * this.alt / 40));
		HeightBitmap[0] = geometricFigures[0].getHeight()
				* ((int) (16 * this.larg / 40) - (int) (10 * this.larg / 40))
				/ geometricFigures[0].getWidth();

		rectColor[0].set((int) (10 * this.larg / 40), 7 * this.alt / 8
				- HeightBitmap[0], (int) (16 * this.larg / 40),
				7 * this.alt / 8);

		rectColor[1].set((int) (17 * this.larg / 40), 7 * this.alt / 8
				- HeightBitmap[1], (int) (22 * this.larg / 40),
				7 * this.alt / 8);
		HeightBitmap[2] = geometricFigures[2].getHeight()
				* ((int) (30 * this.larg / 40) - (int) (24 * this.larg / 40))
				/ geometricFigures[2].getWidth();

		rectColor[2].set((int) (24f * this.larg / 40), 7 * this.alt / 8
				- HeightBitmap[2], (int) (30 * this.larg / 40),
				7 * this.alt / 8);
		HeightBitmap[3] = geometricFigures[3].getHeight()
				* ((int) (37.5 * this.larg / 40) - (int) (33 * this.larg / 40))
				/ geometricFigures[3].getWidth();

		rectColor[3].set((int) (33 * this.larg / 40), 7 * this.alt / 8
				- HeightBitmap[3], (int) (37.5 * this.larg / 40),
				7 * this.alt / 8);
